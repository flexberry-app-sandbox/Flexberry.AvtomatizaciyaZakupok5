...
namespace IIS.Avtomatizaciya_zakupok5
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        /// </summary>
        // *** Start programmer edit section *** (ТЧЗаказ.ОтчеЗакупках CustomAttributes)

        // *** End programmer edit section *** (ТЧЗаказ.ОтчеЗакупках CustomAttributes)
        [Agregator()]
        [NotNull()]
        ...
        public virtual IIS.Avtomatizaciya_zakupok5.ОтчеЗакупках ОтчеЗакупках
        {
            get
            {
                // *** Start programmer edit section *** (ТЧЗаказ.ОтчеЗакупках Get start)

                // *** End programmer edit section *** (ТЧЗаказ.ОтчеЗакупках Get start)
                IIS.Avtomatizaciya_zakupok5.ОтчеЗакупках result = this.fОтчеЗакупках;
                // *** Start programmer edit section *** (ТЧЗаказ.ОтчеЗакупках Get end)

                // *** End programmer edit section *** (ТЧЗаказ.ОтчеЗакупках Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (ТЧЗаказ.ОтчеЗакупках Set start)

                // *** End programmer edit section *** (ТЧЗаказ.ОтчеЗакупках Set start)
                this.fОтчеЗакупках = value;
                // *** Start programmer edit section *** (ТЧЗаказ.ОтчеЗакупках Set end)

                // *** End programmer edit section *** (ТЧЗаказ.ОтчеЗакупках Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Avtomatizaciya_zakupok5.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Avtomatizaciya_zakupok5.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Avtomatizaciya_zakupok5.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Avtomatizaciya_zakupok5.ОтчеЗакупках fОтчеЗакупках) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fОтчеЗакупках)))
        {
        }
        
        public IIS.Avtomatizaciya_zakupok5.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Avtomatizaciya_zakupok5.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Avtomatizaciya_zakupok5.ТЧЗаказ dataobject)
        {
