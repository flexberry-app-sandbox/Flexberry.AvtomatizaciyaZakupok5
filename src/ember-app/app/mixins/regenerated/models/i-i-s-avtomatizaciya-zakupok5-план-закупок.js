...
export let Model = Mixin.create({
  ...
  план: DS.hasMany('i-i-s-avtomatizaciya-zakupok5-план', { inverse: 'планЗакупок', async: false })
});
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('ПланЗакупокE', 'i-i-s-avtomatizaciya-zakupok5-план-закупок', {
    ...
    план: hasMany('i-i-s-avtomatizaciya-zakupok5-план', 'План', {
      номенклатура: belongsTo('i-i-s-avtomatizaciya-zakupok5-номенклатура', 'Номенклатура', {
        ...
        контрагенты: belongsTo('i-i-s-avtomatizaciya-zakupok5-контрагенты', '', {
