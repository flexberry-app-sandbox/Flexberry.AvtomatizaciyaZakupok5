...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok5 номенклатура l');

test('testing i-i-s-avtomatizaciya-zakupok5-номенклатура-l', function(assert) {
