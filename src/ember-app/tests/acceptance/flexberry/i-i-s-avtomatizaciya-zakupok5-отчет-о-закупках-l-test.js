...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok5 отчет о закупках l');

test('testing i-i-s-avtomatizaciya-zakupok5-отчет-о-закупках-l', function(assert) {
