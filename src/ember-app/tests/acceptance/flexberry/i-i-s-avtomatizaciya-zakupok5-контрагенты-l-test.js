...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok5 контрагенты l');

test('testing i-i-s-avtomatizaciya-zakupok5-контрагенты-l', function(assert) {
