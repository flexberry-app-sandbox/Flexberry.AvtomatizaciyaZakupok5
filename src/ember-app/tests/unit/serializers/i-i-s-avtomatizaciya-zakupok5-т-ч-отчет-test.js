...
moduleForModel('i-i-s-avtomatizaciya-zakupok5-т-ч-отчет', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok5-т-ч-отчет', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok5-т-ч-отчет',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
