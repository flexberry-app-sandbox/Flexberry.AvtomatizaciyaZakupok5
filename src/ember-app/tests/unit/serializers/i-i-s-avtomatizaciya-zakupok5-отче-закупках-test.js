...
moduleForModel('i-i-s-avtomatizaciya-zakupok5-отче-закупках', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok5-отче-закупках', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok5-отче-закупках',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
